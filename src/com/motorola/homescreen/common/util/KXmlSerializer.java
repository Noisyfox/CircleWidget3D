  ...
  implements XmlSerializer
{
    ...
    throws IOException
  {
    ...
    label175: StringBuilder localStringBuilder = new StringBuilder().append("n");
    int j = this.auto;
    this.auto = (j + 1);
    String str1 = j;
    ...
    throws IOException
  {
    ...
    if (i < paramString.length())
    {
      ...
      {
      default:
        label92: if ((j >= 32) && (j != 64) && ((j < 127) || (this.unicode)))
          this.writer.write(j);
        break;
      case 9:
      case 10:
    ...
    throws IOException
  {
    ...
    label131: for (String str = "yes"; ; str = "no")
    {
      localWriter.write(str);
      this.writer.write("' ");
      this.writer.write("?>");
    ...
    throws IOException
  {
    ...
    label210: String[] arrayOfString1 = this.elementStack;
    int j = i + 1;
 ...
 * Qualified Name:     com.motorola.homescreen.common.util.KXmlSerializer
