...
public abstract class Circle
{
  ...
  public abstract boolean handleFling(Messenger paramMessenger, Message paramMessage, Float paramFloat);
  ...
  public View prepareCircle(int paramInt1, int paramInt2)
  {
    ...
    this.mBitmap = Bitmap.createBitmap(paramInt2, paramInt2, Bitmap.Config.ARGB_8888);
  ...
  {
    return PreferenceManager.getDefaultSharedPreferences(this.mContext).getBoolean(paramString, false);
  }
 ...
 * Qualified Name:     com.motorola.widget.circlewidget3d.Circle
