...
public class CircleWeather extends Circle
{
  ...
  public static final String[] VISIBILITY_SHAPE_NAMES = { "circle_weather/weathereffects/conditionfront", "circle_weather/weathereffects/clouds2front", "circle_weather/rainfront", "circle_weather/rainback", "circle_weather/weathereffects/planetfront", "circle_weather/weathereffects/pointLight" };
  ...
  private CircleWeather(Context paramContext)
  {
    ...
    this.mCurrentTempTextSize = localResources.getDimensionPixelSize(2131165198);
    this.mCurrentTempSmallTextSize = localResources.getDimensionPixelSize(2131165199);
  }
    ...
    while (true)
      if (j < i)
        try
        {
          ...
          Integer localInteger = Integer.valueOf(localJSONObject.optInt("id"));
          if (this.mWeatherInfo.put(localInteger, localJSONObject) == null)
            this.mWeatherOrder.put(Integer.valueOf(j), localInteger);
          j++;
        }
        catch (JSONException localJSONException)
        {
          while (true)
            Log.w("Circle", "fetchWeatherInfoFromJSON Info Exception : ", localJSONException);
        }
  }

  private void flipWeatherToCity(Messenger paramMessenger, Message paramMessage, Float paramFloat, long paramLong)
  {
    boolean bool1;
    float f;
    if (!this.mIsFlipped)
    {
      ...
      Utility.changeVisibility(paramMessenger, new String[] { "circle_weather/weathereffects/pointLight", "circle_weather/weathereffects/planetfront", "circle_weather/weathereffects/conditionfront", "circle_weather/weathereffects/clouds2front" }, new boolean[] { 0, 0, 0, 0 });
    ...
    {
      Utility.flipCircle(paramMessenger, "circle_weather", f, paramLong, bool2, "weather_fling_id");
      preUpdateCircle();
      return;
      bool1 = false;
      break;
  ...
  private Bitmap getCityScreen(int paramInt)
  {
    ...
    while (true)
    {
      try
      {
        j = ((Integer)this.mWeatherOrder.get(Integer.valueOf(paramInt))).intValue();
        localJSONObject = (JSONObject)this.mWeatherInfo.get(Integer.valueOf(j));
          ...
          else
          {
            ...
            if (k == 0)
            {
              if (this.mTodayHigh != null)
                this.mTodayHigh.setText(localJSONObject.optString("high") + '°');
              TextView localTextView1 = this.mTodayLow;
              i = 0;
              if (localTextView1 != null)
                this.mTodayLow.setText(localJSONObject.optString("low") + '°');
            }
            if (i != 0)
            {
  ...
  {
    return (this.mWeatherInfo != null) && (!this.mWeatherInfo.isEmpty()) && (this.mWeatherOrder != null) && (!this.mWeatherOrder.isEmpty());
  }
  ...
  private void retrieveWeatherInfo()
  {
    ...
    try
    {
      ...
      if (localJSONArray.length() > 0)
      {
        ...
        this.mCurrentId = localSharedPreferences.getInt("weather_top_city_id", -1);
      }
      return;
    }
    catch (Exception localException)
  ...
  {
    Intent localIntent = new Intent("com.motorola.weather.action.START_WEATHER_APPLICATION");
    ...
    catch (Exception localException)
    {
      do
      {
        ...
        Toast.makeText(this.mContext, this.mContext.getResources().getString(2131230739), 1).show();
      }
  ...
  {
    mTopCityId = -1;
    Intent localIntent = new Intent("com.motorola.weather.action.START_WEATHER_SETTINGS");
  ...
  private void storeWeatherInfo()
  {
    ...
    if (isCitiesAvailable())
    {
      ...
      for (int j = 0; j < i; j++)
      {
        int k = ((Integer)this.mWeatherOrder.get(Integer.valueOf(j))).intValue();
        localJSONArray.put((JSONObject)this.mWeatherInfo.get(Integer.valueOf(k)));
      }
    }
  ...
  public void flingWeatherCircle(Messenger paramMessenger, Message paramMessage, Float paramFloat, long paramLong)
  {
    ...
    while (true)
    {
      flipWeatherToCity(paramMessenger, paramMessage, paramFloat, paramLong);
      return;
      this.mCurrentId = -1;
      continue;
  ...
  public WeatherCondition getWeatherCondition()
  {
    ...
    if ((isCitiesAvailable()) && (this.mCurrentId != -1))
    {
      try
      {
        int i = ((Integer)this.mWeatherOrder.get(Integer.valueOf(this.mCurrentId))).intValue();
        localJSONObject = (JSONObject)this.mWeatherInfo.get(Integer.valueOf(i));
        if (localJSONObject != null);
  ...
  public WeatherCondition getWeatherConditionDebug(WeatherCondition paramWeatherCondition)
  {
  ...
  public boolean handleAnimationComplete(String paramString)
  {
    ...
    {
      Utility.flipCircle(null, "circle_weather/weathereffects", 0.0F, 0L, bool3, null);
      new Thread(new Runnable()
      {
        public void run()
        {
  ...
  public void handleTopCityChanged(Context paramContext, Intent paramIntent)
  {
    ...
    for (int k = 0; ; k++)
    {
      ...
      if (k < j)
      {
        if (((Integer)this.mWeatherOrder.get(Integer.valueOf(k))).intValue() == i)
        {
          this.mCurrentId = k;
          m = 1;
        }
  ...
  public void postUpdateCircle(boolean paramBoolean)
  {
    ...
    {
      Utility.moveTexture(null, str, 0, f1 - f2, localWeatherCondition.rainName[1], 0.0F, 2500L);
      Utility.changeVisibility(null, VISIBILITY_SHAPE_NAMES, getShapeVisibilities(localWeatherCondition));
      if (localWeatherCondition.planetName != null)
        Utility.moveTexture(null, localWeatherDisplayIds.planetId, 0, localWeatherCondition.planetName[0], localWeatherCondition.planetName[1], 0.0F, 0L);
      if (localWeatherCondition.conditionName != null)
        Utility.moveTexture(null, localWeatherDisplayIds.conditionId, 0, localWeatherCondition.conditionName[0], localWeatherCondition.conditionName[1], 0.0F, 0L);
      if (localWeatherCondition.condition2Name == null)
        break;
      Utility.moveTexture(null, localWeatherDisplayIds.condition2Id, 0, localWeatherCondition.condition2Name[0], localWeatherCondition.condition2Name[1], 0.0F, 0L);
      return;
    }
  }
  ...
  public void preUpdateCircle()
  {
    ...
    WeatherDisplayIds localWeatherDisplayIds = this.mCurrentDisplayIds;
    WeatherCondition localWeatherCondition = mCurrentCondition;
    Utility.updateTexture(null, this.mContext, this.mThemePackage, localWeatherDisplayIds.sideId, localWeatherCondition.dayNightName, true, true);
    ...
    for (Bitmap localBitmap = getCityScreen(this.mCurrentId); ; localBitmap = getSetupScreen())
    {
      ...
      Utility.moveTexture(null, localWeatherDisplayIds.sideId, 0, -1.0F, 0.0F, 0.0F, 2500L);
      if (localWeatherCondition.rainName != null)
        Utility.moveTexture(null, localWeatherDisplayIds.rainId, 0, localWeatherCondition.rainName[0], localWeatherCondition.rainName[1], 0.0F, 0L);
      return;
    }
  }
  ...
  {
    Intent localIntent = new Intent("com.motorola.weather.action.NEED_WEATHER_INFO");
  ...
  {
    Intent localIntent = new Intent("com.motorola.weather.action.START_WEATHER_SERVICE");
    try
    {
      this.mContext.sendBroadcast(localIntent);
      return;
  ...
  {
    Intent localIntent = new Intent("com.motorola.weather.action.STOP_WEATHER_SERVICE");
    try
    {
      this.mContext.sendBroadcast(localIntent);
      return;
  ...
  public void topCityChanged(int paramInt)
  {
    if (isCitiesAvailable())
    {
      Intent localIntent = new Intent("com.motorola.weather.action.TOP_CITY_CHANGED");
      int i = paramInt;
      if (paramInt != -1)
        i = ((Integer)this.mWeatherOrder.get(Integer.valueOf(paramInt))).intValue();
    ...
    Log.e("Circle", "Not sending top cityChanged because no city in the map");
  }
    ...
    try
    {
      ...
      if ((bool1) || ((i != -1) && (i != mTopCityId)))
      {
        ...
        if (bool2)
        {
          ...
          if (i1 < n)
          {
            if (((Integer)this.mWeatherOrder.get(Integer.valueOf(i1))).intValue() != i)
              break label256;
 ...
 * Qualified Name:     com.motorola.widget.circlewidget3d.CircleWeather
