...
public class CheckinEventWrapper {
	...
	static {
		try {
			Class<?> localClass1 = Class
					.forName("com.motorola.android.provider.CheckinEvent");
			Class<?> localClass2 = Class
					.forName("com.motorola.data.event.api.Event");
			Class<?>[] arrayOfClass = new Class[4];
			arrayOfClass[0] = String.class;
			arrayOfClass[1] = String.class;
			arrayOfClass[2] = String.class;
			arrayOfClass[3] = Long.TYPE;
			sMethodConstructor = localClass1
					.getDeclaredConstructor(arrayOfClass);
			sMethodSetValue = localClass2.getDeclaredMethod("setValue",
					new Class[] { String.class, String.class });
			sMethodPublish = localClass1.getDeclaredMethod("publish",
	...
	public void publish(ContentResolver paramContentResolver) {
		if ((sSucessfullyInit) && (this.mCheckinEvent != null))
			;
		try {
			sMethodPublish.invoke(this.mCheckinEvent,
					new Object[] { paramContentResolver });
			return;
		} catch (Throwable localThrowable) {
			Log.w(TAG, "Reflection failed");
		}
	...
	public boolean setHeader(String paramString1, String paramString2,
		...
		if (sSucessfullyInit)
			try {
				...
				this.mCheckinEvent = localConstructor
	...
	public void setValue(String paramString1, String paramString2) {
		if ((sSucessfullyInit) && (this.mCheckinEvent != null))
			;
		try {
			sMethodSetValue.invoke(this.mCheckinEvent, new Object[] {
 ...
 * com.motorola.widget.circlewidget3d.CheckinEventWrapper JD-Core Version: 0.6.2
 */