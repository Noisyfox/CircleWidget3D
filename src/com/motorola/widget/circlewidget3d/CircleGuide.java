...
public class CircleGuide extends Circle
{
  ...
  private CircleGuide(Context paramContext)
  {
    ...
    prepareCircle(2130903054, CircleConsts.GUIDE_BITMAP_SIZE.intValue());
    this.mIsFlipped = true;
    SharedPreferences localSharedPreferences = PreferenceManager.getDefaultSharedPreferences(this.mContext);
    sIsGuidemeCircleEnabled = localSharedPreferences.getBoolean("show_guide_me", true);
    sIsHideGuidemeImage = localSharedPreferences.getBoolean("do_not_display_guide_tip_image", false);
  }
  ...
  public static Intent getGuideAppIntent()
  {
    ...
    localIntent.setComponent(new ComponentName("com.motorola.genie", "com.motorola.genie.app.GenieMainActivity"));
  ...
  {
    Utility.flipCircle(paramMessenger, "circle_help", paramFloat.floatValue(), this.mIsFlipped);
    if (!this.mIsFlipped);
  ...
  {
    boolean bool = PreferenceManager.getDefaultSharedPreferences(this.mContext).getBoolean("show_guide_me", sIsGuidemeCircleEnabled);
    int i;
    if (bool != sIsGuidemeCircleEnabled)
    {
      sIsGuidemeCircleEnabled = bool;
      ...
      if (i != 0)
      {
        ...
        Utility.changeVisibility(null, new String[] { "circle_help" }, arrayOfBoolean);
      }
      if (!sIsGuidemeCircleEnabled)
        break label87;
    }
 ...
 * Qualified Name:     com.motorola.widget.circlewidget3d.CircleGuide
