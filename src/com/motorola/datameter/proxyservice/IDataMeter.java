...
public abstract interface IDataMeter extends IInterface {
	public abstract long getCurrentUsageBytes() throws RemoteException;

	public abstract int getPolicyCycleDay() throws RemoteException;

	public abstract long getPolicyLimitBytes() throws RemoteException;
	...
	public static abstract class Stub extends Binder implements IDataMeter {
		...
		private static class Proxy implements IDataMeter {
			...
			public long getCurrentUsageBytes() throws RemoteException {
			...
			public long getPolicyLimitBytes() throws RemoteException {
				Parcel localParcel1 = Parcel.obtain();
				Parcel localParcel2 = Parcel.obtain();
				try {
					localParcel1.writeInterfaceToken(DESCRIPTOR);
 ...
 * com.motorola.datameter.proxyservice.IDataMeter JD-Core Version: 0.6.2
 */